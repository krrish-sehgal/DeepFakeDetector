...
// Function to fetch data using JWT token from Chrome local storage
async function getDeepfakePercentage(imageDataUrl) {
  ...
  try {
    ...
    // Construct your fetch request with the Authorization header
    const response = await fetch("http://localhost:4000/extension/upload", {
      method: "POST",
      headers: {
